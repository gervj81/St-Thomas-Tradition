...
(function () {
  ...
  const CHAPTER_VISUAL_STATES = {
    ...
    'chapter-18': {
      state: 'The War for the Past',
      mode: 'Apologetics',
      evidence: 'Printed records',
      pressure: 100,
      image: GENERATED_ASSETS.syriacTexture,
    ...
    try {
      ...
      for (let i = 0; i <= index; i++) {
        ...
        if (marker) {
          ...
          if (marker.includes('PART IV')) currentPart = '4';
        }
      }
  ...
  function getChapterVisualState(chapter, currentPart) {
    const fallback = currentPart === '2'
      ...
      : currentPart === '4'
      ? {
          state: 'Scholarly debate',
          mode: 'Apologetics',
          evidence: 'Printed histories',
          pressure: 100,
          image: GENERATED_ASSETS.syriacTexture,
          caption: 'Print, debate, and critical history shape the reception of the St. Thomas tradition.',
        }
      : {
